...
Задача 15. Стипендия за семестр (процедура с курсором)

Задание: Создайте процедуру AssignScholarships(), которая перебирает всех студентов и начисляет стипендию согласно среднему баллу, записывая результат в таблицу scholarships(student_id, amount, assigned_date).
